...
if (isset($_POST['companyName'])   &&
      ...
      isset($_POST['password']))
  {
    ...
    $query    = "INSERT INTO posters VALUES" .
      "('$companyName', '$email', '$adrress', '$country', '$province', '$postalCode', '$password')";
...
echo <<<_END
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>FindMeAJob.ca</h2>
        <p class="lead">Please enter your company information below to complete your account creation.</p>
      </div>

      <div class="row">
        
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Job Poster Creation</h4>
          <form action="poster-account-creation.php" method="post" class="needs-validation" novalidate="">
            <div class="row">
